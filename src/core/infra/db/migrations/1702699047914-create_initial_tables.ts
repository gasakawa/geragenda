...
export class CreateInitialTables1702699047914 implements MigrationInterface {
  name = 'CreateInitialTables1702699047914';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "config"."tenants" ("id" bigint GENERATED BY DEFAULT AS IDENTITY NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "name" text NOT NULL, "is_active" boolean NOT NULL DEFAULT true, "cnpj" text, CONSTRAINT "PK_53be67a04681c66b87ee27c9321" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "config"."addresses" ("id" bigint GENERATED BY DEFAULT AS IDENTITY NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "street" text NOT NULL, "number" integer NOT NULL, "zipCode" text, "neighborhood" text, "city" text, "state" text, "tenant_id" bigint, CONSTRAINT "PK_745d8f43d3af10ab8247465e450" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "config"."tenant_services" ("id" bigint GENERATED BY DEFAULT AS IDENTITY NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "name" text NOT NULL, "price" numeric(18,2) NOT NULL DEFAULT '0', "discount" numeric(18,2) DEFAULT '0', "duration" numeric(18,2) NOT NULL DEFAULT '0', "category_id" bigint, "tenant_id" bigint, CONSTRAINT "PK_1b2cb3fef53fb04901839764993" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "config"."categories" ("id" bigint GENERATED BY DEFAULT AS IDENTITY NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "name" text NOT NULL, "description" text, CONSTRAINT "PK_24dbc6126a28ff948da33e97d3b" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "config"."plans" ("id" bigint GENERATED BY DEFAULT AS IDENTITY NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "name" text NOT NULL, "is_active" boolean NOT NULL DEFAULT true, "monthly_price" numeric(18,2) NOT NULL, "discount_first_month" numeric(18,2) NOT NULL, "annually_price" numeric(18,2) NOT NULL, "discount_first_year" numeric(18,2) NOT NULL, "max_staff" integer NOT NULL DEFAULT '0', "max_sms" integer NOT NULL DEFAULT '0', "max_email" integer NOT NULL DEFAULT '0', CONSTRAINT "PK_3720521a81c7c24fe9b7202ba61" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "config"."roles" ("id" bigint GENERATED BY DEFAULT AS IDENTITY NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "name" text NOT NULL, CONSTRAINT "PK_c1433d71a4838793a49dcad46ab" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "config"."users" ("id" bigint GENERATED BY DEFAULT AS IDENTITY NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "full_name" text NOT NULL, "email" text NOT NULL, "is_active" boolean NOT NULL DEFAULT true, "mobile_number" text NOT NULL, "tenant_id" bigint, CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "app"."schedules" ("id" bigint GENERATED BY DEFAULT AS IDENTITY NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "tenant_id" bigint NOT NULL, "staff_id" bigint NOT NULL, "tenant_service_id" bigint, "date_scheduled" TIMESTAMP WITH TIME ZONE NOT NULL, "is_available" boolean NOT NULL DEFAULT true, CONSTRAINT "PK_7e33fc2ea755a5765e3564e66dd" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "app"."schedule_services" ("id" bigint GENERATED BY DEFAULT AS IDENTITY NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "client_id" bigint NOT NULL, "tenant_id" bigint NOT NULL, "staff_id" bigint NOT NULL, "tenant_service_id" bigint NOT NULL, "date_scheduled" TIMESTAMP WITH TIME ZONE NOT NULL, CONSTRAINT "PK_cb0b94f10eab852f9a08f348590" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP TABLE "config"."plans"`);
